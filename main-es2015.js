...
/* harmony import */ var _popup_popup_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./popup/popup.component */ "./src/app/popup/popup.component.ts");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        declarations: [
            ...
            _popup_popup_component__WEBPACK_IMPORTED_MODULE_7__["PopupComponent"]
        ],
        imports: [
...
let HeaderComponent = class HeaderComponent {
    ...
    // 전체삭제 메세지창 띄우기 
    removeConfirmShow() {
        let result = confirm('메모를 전체 삭제 하시겠습니까?');
        if (result) {
    ...
    onCancel() {
        ...
        // 취소를 누르면 리스트의 클래스 값을 모두 초기화해야한다. 
        this.clear.emit();
    }
...
let ListComponent = class ListComponent {
    ...
    editMemoShow(memo) {
        ...
        this.memoService.changeFlag(this.flags);
        //edit이벤트가 발생될 때 한건에 대한 memo를 전달해준다.
        this.edit.emit(memo);
    }
...
module.exports = __webpack_require__(/*! E:\김훈\08.웹표준코딩실무\05.angular\memo\src\main.ts */"./src/main.ts");
